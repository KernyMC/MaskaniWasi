...
const Hero: React.FC = () => {
  // Use placeholder images (in a real project, replace these with actual project images)
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white animate-fade-in">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold tracking-wide mb-4">
          MASKANI WASI
        </h1>
        <p className="text-xl md:text-3xl lg:text-4xl font-display italic mb-8">
          Sembrando hoy un futuro sostenible
        </p>
        <div className="max-w-3xl mx-auto">
          <p className="text-base md:text-lg bg-black bg-opacity-30 backdrop-blur-sm p-6 rounded-lg">
        ...
        <div className="mt-8">
          <NewsletterButton variant="primary" className="text-lg py-3 px-8" />
        </div>
      </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        ...
        >
          <span className="text-sm mb-1">Conocer más</span>
          <svg 
